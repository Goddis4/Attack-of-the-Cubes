...
void AMyPlayer::Tick(float DeltaTime)
{
	...
	// Restricting movement within the boundaries
...
void AMyPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhanceInputCom = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhanceInputCom->BindAction(HShootInput, ETriggerEvent::Started, this, &AMyPlayer::HShoot);
	}
}
...
void AMyPlayer::HShoot(const FInputActionValue& input)
{
